          ...
          <div className="bg-white border border-slate-200 rounded-[32px] p-8 max-w-2xl mx-auto my-12 shadow-sm space-y-6 relative overflow-hidden text-left">
            ...
            <div className="space-y-8 text-left">
              ...
              {activeDashboardTab === 'inicio' ? (
                ...
                <div className="bg-white border border-slate-200 rounded-[32px] p-8 max-w-2xl mx-auto my-12 shadow-sm text-center">
                  <div className="flex flex-col items-center justify-center py-8">
                    <div className="w-16 h-16 rounded-2xl bg-slate-100 flex items-center justify-center mb-4">
                      <Dumbbell className="w-8 h-8 text-slate-400" />
                    </div>
                    <h3 className={`${archivoFont.className} text-xl font-black text-slate-900 uppercase tracking-tight mb-2`}>
                      Proximamente
                    </h3>
                    <p className="text-sm text-slate-500 max-w-md">
                      Los entrenamientos del equipo estaran disponibles pronto. Tu entrenador podra planificar sesiones semanales con horarios y ubicaciones.
                    </p>
                  </div>
                </div>
              ) : (
